//Programa de pieza principal UC Mutek2019
...
//Variables para capturar el video, audio y Osc
Capture video;
...
void draw() {
  ...
  //Elimina disparadores de lineas
  ...
  if (flag_generate_grid == true)
  {
    ...
    //Verifica si el Grid está armado
  ...
  //Pantalla en negro pero con audios sonando
...
//Funcion para actualizar video en los Grids
...
//Genera barridos de grids con base en los micrófonos
...
//Función para dibujar target en modo rectangulo
...
//Función para dibujar cuadro rojo target
...
//Dibuja contorno negro para grids
...
//Funcion para dibujar plantilla verde
...
//Dibuja lineas verdes/blancas sobre grids
